...
double getDistance(double latitude1, double longitude1, double latitude2, double longitude2)
{
	...
	double latitude = abs((latitude2 - latitude1)) * rad;
	double longitude = abs((longitude2 - longitude1)) * rad;
...
int main()
{
	cout << "Distance in km " << getDistance(32.17, 73.21, 34.77, 78.1) << endl; //тут координаты для примера просто
}
